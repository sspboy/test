            ...
            >
                ...
                <template #renderItem="{ item }">
                    ...
                    <a-card size="small" style="margin:0px 10px 10px 0;font-size: 12px;">
                        ...
                        <template #cover>
                            <span style="width: 100%;height: 100px;background-color: #f2f2f2;display: block;text-align: center;justify-content: center;align-items: center;display: flex;" v-if="item.image.url !== undefined && item.image.url !== ''">
                                <a-image :src="item.image.url" width="80" height="80px"/>
                            </span>
                            <span style="width: 100%;height: 100px;background-color: #f2f2f2;display: block;text-align: center;justify-content: center;align-items: center;display: flex;" v-else-if="item.image.url == ''">
                                <a-image
                                :width="90"
                                :height="90"
...
export default {
    ...
    setup(props) {
        ...
        const page_turning = (data)=>{
            ...
            navData.value.page_num = data.page - 1;
