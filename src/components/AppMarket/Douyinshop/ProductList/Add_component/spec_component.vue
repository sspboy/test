      ...
      name="SPECS" >
        ...
        <template v-for="(item, index) in SPECS.Obj" :key="item.index">
          ...
          <div class="font_size_12 box_style">
            ...
            <!--规格值 开始-->
            <a-row v-if="!item.disabled" 
              style="padding: 0 0 0 0;margin-bottom: 10px;" 
              :gutter="[16,16]"
            >


              <template v-for="(v_item, spec_value_index) in item.values">
                      ...
                      <template v-if="item.value_display_style !== 'measure'">
                        ...
                        >
                            <a-space>
                              ...
                              <!-- 下拉 -->
                              <span v-else-if="item.value_display_style === 'select'">
                                  <a-select
                                    ref="select"
                                    v-model:value="v_item.value_name"
                                    style="width: 120px"
                                  ...
                                  >
                                    <a-select-option v-for="(i,index) in item.property_values" value="jack">{{ i.sell_property_value_name }}</a-select-option>
                                  </a-select>
                              </span>
