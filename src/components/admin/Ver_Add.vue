...
<!--              <a-input v-model:value="formdata.menu_setting" class="font_size_12" placeholder="选择版本关联的菜单功能" type="text" />-->
                <a-tree-select
                  v-model:value="value"
                  style="width: 100%"
          ...
          <a-col :span="12">
            <a-form-item label="价格" name="price">
              <a-input v-model:value="formdata.def_name" class="font_size_12" placeholder="输入价格" type="number" />
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="16">
          ...
          <a-col :span="12">
            <a-form-item label="使用人数" name="sub_account_number">
              <a-input v-model:value="formdata.name" class="font_size_12" placeholder="输入版本人数" type="number" />
            </a-form-item>
          </a-col>

          <a-col :span="12">
            <a-form-item label="使用时长" name="duration">
              <a-input v-model:value="formdata.def_name" class="font_size_12" placeholder="输入使用多少个月" type="number" />
            </a-form-item>
          </a-col>
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const formdata = computed(()=>{
      return reactive({
        treeData:store.state.menu.message.data_list.data
      })
    })// 表单数据绑定
